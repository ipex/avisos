...
{if $smarty.get.action}
	...
	<form action="{$rlBaseC}action={if $smarty.get.action == 'add'}add{elseif $smarty.get.action == 'edit'}edit&amp;admin={$smarty.get.admin}{/if}" method="post">
		<!-- add/edit new admin -->
			...
			columns: [
				{
					...
					renderer: function(data) {
						...
						{
							out += "<img class='remove' ext:qtip='"+lang['ext_delete']+"' src='"+rlUrlHome+"img/blank.gif' onClick='rlConfirm( \""+lang['ext_notice_'+delete_mod]+"\", \"xajax_deleteAdmin\", \""+Array(data)+"\", \"admin_load\" )' />";
						}
						out += "</center>";
