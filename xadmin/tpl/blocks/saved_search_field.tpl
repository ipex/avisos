...
<tr>
	...
	{elseif $field.Type == 'price'}
		<span class="text">{$lang.from}</span> {if $field.value.from}{$field.value.currency}{str2money string=$field.value.from}{else}{$lang.any}{/if} <span class="text">{$lang.to}</span> {if $field.value.to}{$field.value.currency}{str2money string=$field.value.to}{else}{$lang.any}{/if} <br />{if empty($field.value.currency)}<span class="text">{$lang.currency}</span> {$lang.any}{/if}
