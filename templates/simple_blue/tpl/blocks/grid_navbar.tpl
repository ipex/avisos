...
<tr>
	...
	<td class="switcher">
		<a rel="nofollow" href="javascript:void(0)" class="table{if $smarty.cookies.grid_mode == 'table' || !isset($smarty.cookies.grid_mode)} active{/if}">{$lang.gallery_view}</a>
		<span class="divider">|</span>
		<a rel="nofollow" href="javascript:void(0)" class="list {if $smarty.cookies.grid_mode == 'list'} active{/if}">{$lang.list_view}</a>
	</td>
</tr>
</table>
