...
{foreach from=$types item='type'}
	...
	{if $categories.$type}
		...
		{/if*}
		<div class="categories{if $listing_type.Ablock_show_subcats} sub_categories_exist{/if}" id="categories_{$type|replace:'_':''}_{$pages_number}">
			<div>
				<ul>
					...
					{foreach from=$categories.$type item='cat' name='fCats'}
						...
						<div class="item">
							<div class="parent-cateory">
								{if !$listing_type.Ablock_show_subcats}
		...
		<script type="text/javascript">
			...
			{if $listing_type.Ablock_columns_number > 1}
			{literal}
			$(document).ready(function(){
