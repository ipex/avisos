...
<div id="area_listing" class="tab_area">
	{if $listing_type.Photo && $photos && $config.pg_gallery_type == 'LightBox'}
	...
	<tr>
		<td valign="top" class="side_bar">
			...
			{if $listing_type.Photo}
				{if $photos}
					{if $config.pg_gallery_type == 'PreviewBox'}
						<div class="photos">
			...
			{foreach from=$listing item='group'}
				{foreach from=$group.Fields item='item' }
					{if !empty($item.value) && $item.Details_page && $item.Key == 'price'}
						<span class="price_tag" id="df_field_price"><span class="top"></span><span class="center"><span></span></span><span class="bottom"></span>{$item.value}</span>
