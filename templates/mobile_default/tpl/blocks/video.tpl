<!-- display video -->
	...
	<div id="player_obj" style="margin-bottom:10px;"></div>
	...
	obj.addVariable("file", "{$smarty.const.RL_URL_HOME}files/{$video.Video}");
	obj.addVariable("image","{$smarty.const.RL_URL_HOME}files/{$video.Preview}");
