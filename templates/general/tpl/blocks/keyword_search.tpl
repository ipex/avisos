...
<form method="post" action="{$rlBase}{if $config.mod_rewrite}{$pages.search}.html{else}?page={$pages.search}{/if}">
	...
	<tr>
		...
		<td style="width: 35px;" class="ralign"><input title="{$lang.search}" class="search" type="submit" name="search" value="&nbsp;" /></td>
	</tr>
	</table>
	...
	<div class="keyword_search_switcher"><a id="refine_keyword_opt2" class="dotted" href="javascript:void(0)">{$lang.advanced_options}</a></div>
